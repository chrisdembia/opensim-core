...
public:
    ...
    virtual void setParameterMin(int aI,double aMin) override;
    virtual double getParameterMin(int aI) const override;

    virtual void setParameterMax(int aI,double aMax) override;
    virtual double getParameterMax(int aI) const override;
    /**
     ...
     */
    virtual double getParameterTime(int aI) const override;
    /**
     * @param aI Index of the parameter.
     ...
     */
    virtual void getParameterNeighborhood(int aI,double &rTLower,double &rTUpper) const override;
     ...
     */
    virtual int getParameterList(double aT,Array<int> &rList) override;
    virtual int getParameterList(double aT1,double aT2,Array<int> &rList) override;
     ...
     */
    virtual void setParameterValue(int aI,double aP) override;
    /// @see setParameterValue()
    virtual double getParameterValue(int aI) const override;
     ...
     */
    virtual void setControlValue(double aT,double aX) override;
    virtual double getControlValue(double aT) override;
    virtual double getControlValueMin(double aT=0.0) override;
    /**
     * This method adds a set of control parameters at the specified time unless
     ...
     */
    virtual void setControlValueMin(double aT,double aX) override;
    virtual double getControlValueMax(double aT=0.0) override;
    /**
     * This method adds a set of control parameters at the specified time unless
     * the specified time equals the time of an existing control node, in which
     * case the parameters of that control node are changed.
     */
    virtual void setControlValueMax(double aT,double aX) override;
     ...
     */
    virtual const double getFirstTime() const override;
    /**
     * The time corresponding to the last ControlLinearNode
     */
    virtual const double getLastTime() const override;
     ...
     */
    virtual void simplify(const PropertySet &aProperties) override;
    /**
     ...
     */
    virtual void filter(double aT) override;
