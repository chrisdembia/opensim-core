...
public:
    ...
    //--------------------------------------------------------------------------
    // SIZE
    virtual int getSize() const override { return(_storage.getSize()); }
    // STATEVECTOR
    int getSmallestNumberOfStates() const;
    virtual StateVector* getStateVector(int aTimeIndex) const override;
    virtual StateVector* getLastStateVector() const override;
    // TIME
    virtual double getFirstTime() const override;
    ...
    virtual int getTimeColumn(Array<double>& rTimes,int aStateIndex=-1) const override;
    virtual void getTimeColumnWithStartTime(Array<double>& rTimes,double startTime=0.0) const override;
    ...
    // STORAGE
    //--------------------------------------------------------------------------
    virtual int append(const StateVector &aVec, bool aCheckForDuplicateTime=true) override;
    virtual int append(const Array<StateVector> &aArray) override;
    virtual int append(double aT,int aN,const double *aY, bool aCheckForDuplicateTime=true) override;
    virtual int append(double aT,const SimTK::Vector& aY, bool aCheckForDuplicateTime=true) override;
    virtual int append(double aT,const Array<double>& aY, bool aCheckForDuplicateTime=true);
    virtual int append(double aT, const SimTK::Vec3& aY,bool aCheckForDuplicateTime=true) override{
        return append(aT, 3, &aY[0], aCheckForDuplicateTime);
    }
    virtual int store(int aStep,double aT,int aN,const double *aY) override;
    ...
    // UTILITY
    //--------------------------------------------------------------------------
    virtual int findIndex(double aT) const override;
    virtual int findIndex(int aI,double aT) const override;
